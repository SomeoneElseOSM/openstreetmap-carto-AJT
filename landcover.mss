...
#landcover {
 [feature = 'leisure_swimming_pool'][zoom >= 14] {
  ...
  [feature = 'power_generator'][way_area >= 2000000][zoom >= 10],
  ...
  [feature = 'natural_unnamedsand'][zoom >= 10] {
    polygon-fill: @sand;
  }

  [feature = 'natural_tidal_sand'][zoom >= 10],
  [feature = 'natural_unnamedtidal_sand'][zoom >= 10] {
  ...
  [feature = 'natural_unnamedgrassland'][zoom >= 10] {
    polygon-fill: #c6e4b4;
  }
  ...
  [feature = 'leisure_dog_park'][zoom >= 10] {
    polygon-fill: @pitch;
    [zoom >= 15] {
      line-width: 0.5;
